...
export default function VerifyOTP() {
    ...
    useEffect(() => {
        ...
        const resolvedEmail = state?.email || storedEmail;
    ...
    const handleResend = async () => {
        ...
        try {
            ...
            if (err.response?.status === 404) {
                setError("Resend OTP is not available right now. Please use the original code sent to your email.");
            } else {
        ...
        <div className="auth-page">
            <div className="auth-left">
                ...
                <div className="auth-feature-list">
                    ...
                    <div className="auth-feature">Valid for 10 minutes</div>
            ...
            <div className="auth-right">
                <div className="auth-card">
                    ...
                    <div className="otp-resend">
                        {countdown > 0 ? (
                            <p>
                                Resend code in <strong style={{ color: "#4f46e5" }}>{countdown}s</strong>
                            </p>
                        ) : (
                            <button
                                type="button"
